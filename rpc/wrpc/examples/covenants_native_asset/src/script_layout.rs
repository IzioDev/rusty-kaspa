...
pub const COVENANT_ID_OFFSET: usize = offset_of!(StatePrefixLayout, covenant_id);
...
pub const SPK_COVENANT_ID_OFFSET: usize = COVENANT_PREFIX_OFFSET + COVENANT_ID_OFFSET;
